...
data={"Name":"Maria","x":65,"y":350,"time":23.62}
#Upload data to firebase
firebase.put("",player,data)

#Get data 
p2_data=firebase.get("",player,data)
...
#Replace file location address on your computer
car2=image_load("Assets/redCar.png",70,60)
...
while carryOn:
 ...
 #update location here 
  ...
  #display the second car using firebase data
  screen.blit(carImg,(p2_data["X"],p2_data["Y"]))
